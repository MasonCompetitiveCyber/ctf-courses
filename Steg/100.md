...
- - [2.3 - Image Manipulation](#image-manipulation)
- [Practice](#practice)
...
```console
$ xxd challenge.jpeg | grep -B 5 flag{
00415b40: e791 5f06 681a 65d7 843e 2cc1 e0eb 82df  .._.h.e..>,.....
00415b50: d997 3320 2fb8 850a 7a03 8f7a fbf6 c7c7  ..3 /...z..z....
00415b60: 1a35 c7c4 26d0 e671 0c1e 6101 73c1 c7e9  .5..&..q..a.s...
00415b70: 5caf c56f 00e8 5a9f 8c6c ae34 9996 2919  \..o..Z..l.4..).
00415b80: 9dde 45e8 a074 e6ae 8d6d 3df1 37a1 ffd9  ..E..t...m=.7...
00415b90: 666c 6167 7b6e 3074 5f73 7573 7d0a       flag{n0t_sus}.
```

Using `strings` with `grep`:
```console
$ strings -n 5 challenge.jpeg | grep -B 5 flag{
w$Gk0<
=E~~j:
C)$`*
8/7w-
